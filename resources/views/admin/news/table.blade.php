    ...
    @foreach($news as $news)
        <tr>
            ...
            <td>
                 ...
                 <a href="{{ route('admin.news.confirm-delete', $news->id) }}" data-toggle="modal" data-target="#delete_confirm">
                     <i class="livicon" data-name="remove-alt" data-size="18" data-loop="true" data-c="#f56954" data-hc="#f56954" title="delete news"></i>
                 </a>
            </td>
        </tr>
    @endforeach
